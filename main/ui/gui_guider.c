...
void init_scr_del_flag(lv_ui *ui)
{
	...
	ui->screen_scan_del = true;
	ui->screen_first_del = true;
	ui->screen_information1_del = true;
	ui->screen_information2_del = true;
	ui->screen_weather1_del = true;
	ui->screen_weather_sunny_del = true;
	ui->screen_weather_cloudy_del = true;
	ui->screen_weather_rainy_del = true;
	ui->screen_remind1_del = true;
	ui->screen_remind2_del = true;
	ui->screen_ChatGPT1_del = true;
	ui->screen_ChatGPT2_del = true;
	ui->screen_medicine_id1_del = true;
	ui->screen_medicine_id_up_del = true;
	ui->screen_medicine_id_loading_del = true;
	ui->screen_medicine_id2_del = true;
	ui->screen_measure1_del = true;
	ui->screen_measure_up_del = true;
	ui->screen_measure_loading_del = true;
	ui->screen_measure2_del = true;
	ui->screen_falling_del = true;
	ui->screen_reminding_del = true;
}

void setup_ui(void)
{
	init_scr_del_flag(&guider_ui);
	setup_scr_screen_first(&guider_ui);
	lv_scr_load(guider_ui.screen_first);
}
