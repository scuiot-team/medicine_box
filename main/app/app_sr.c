...
static const sr_cmd_t g_default_cmd_info[] = {
    ...
    // Chinese
    {SR_CMD_BOX_ON, SR_LANG_CN, 0, "吃药", "chi yao", {NULL}},
    {SR_CMD_BOX_OFF, SR_LANG_CN, 0, "关闭药盒", "guan bi yao he", {NULL}},
    {SR_CMD_HEART_TEST, SR_LANG_CN, 0, "测心率", "ce xin lv", {NULL}},
    ...
    {SR_CMD_GPT, SR_LANG_CN, 0, "发烧了怎么办", "fa shao le zen me ban", {NULL}},
    ...
    {SR_CMD_WEATHER, SR_LANG_CN, 0, "今天天气怎么样", "jin tian tian qi zen me yang", {NULL}},
    {SR_CMD_IDENTIFY, SR_LANG_CN, 0, "识别药品", "shi bie yao pin", {NULL}},
    {SR_CMD_BOX1, SR_LANG_CN, 0, "打开药盒一", "da kai yao he yi", {NULL}},
    {SR_CMD_BOX2, SR_LANG_CN, 0, "打开药盒二", "da kai yao he er", {NULL}},
    {SR_CMD_BOX3, SR_LANG_CN, 0, "打开药盒三", "da kai yao he san", {NULL}},
    {SR_CMD_BOX4, SR_LANG_CN, 0, "打开药盒四", "da kai yao he si", {NULL}},
    {SR_CMD_BOX5, SR_LANG_CN, 0, "打开药盒五", "da kai yao he wu", {NULL}},
    {SR_CMD_BOX6, SR_LANG_CN, 0, "打开药盒六", "da kai yao he liu", {NULL}},
    {SR_CMD_BOX7, SR_LANG_CN, 0, "打开药盒七", "da kai yao he qi", {NULL}},
    {SR_CMD_WEATHER, SR_LANG_CN, 0, "显示天气", "xian shi tian qi", {NULL}},
...
esp_err_t app_sr_start(bool record_en)
{
    ...
    if (record_en) {
        ...
        for (size_t i = 0; i < 100; i++) {
            sprintf(file_name, "/spiffs/Record_%02d.pcm", i);
            g_sr_data->fp = fopen(file_name, "r");
            if (g_sr_data->fp != NULL) {
                fclose(g_sr_data->fp);
                continue; // 如果文件存在，继续下一个序号
            } else {
                ESP_LOGI(TAG,"file id:%d",i);
                break; // 如果文件不存在，跳出循环
            }
        }
